...
namespace Store.Tests.Domain
{
    ...
    {
        private readonly Customer _customer = new Customer("Leonardo Sena", "leonardo@balta.io");
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_pagamento_de_um_pedido_seu_status_deve_ser_aguardando_entrega()
        {
            var order = new Order(_customer, 0, null);
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_novo_item_com_quantidade_zero_ou_menor_o_mesmo_nao_pode_ser_adicionado()
        {
            var order = new Order(_customer, 0, null);
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_uma_taxa_entrega_de_10_o_valor_do_pedido_deve_ser_60()
        {
            var order = new Order(_customer, 10, _discount);
